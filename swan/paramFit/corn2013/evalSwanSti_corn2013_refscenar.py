...
mdl.printSimuInfo(mdl.times, cPelak, sPelak, nPelak, bPelak)
...
fig,ax = pltSwan.varproc_Setup_2x3(tini=tSti[0])
pltSwan.varProc_2x3( ax, mdl.times, cPelak, sPelak, nPelak, bPelak, lbl=' SWAN' )
