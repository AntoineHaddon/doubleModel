...
# mdl.Sfc =soilParam["totalSfc"]              # 0.288
# mdl.Sw =soilParam["totalSwp"]               # 0.122
# mdl.Sstar = (mdl.Sfc +mdl.Sw)/2             # 0.205
...
# paramBnds += [['cMax', 0.9, 0.99]]
# paramBnds += [['gamma', 1e-4, 0.01]]
# paramBnds += [['tsen', 50, 250]]

paramBnds += [['Wstar', 1e-5, 100]]
# paramBnds += [['ET0ref', 4, 5]]
